...
import { WEB_MESSAGE_CODE_ENTRIES, WEB_MESSAGE_CODES } from '../src/messages/codes.js';
...
const HEADER = '# Web messages configuration (source of truth)';
